...
function iGetCityCode(cityName) {
	var name = "";
	var key = "";
	for (var i = 0; i < cityCodes.length; i++) {
		var citys = cityCodes[i];
		if (cityName.indexOf(citys['name']) != -1
				|| citys['name'].indexOf(cityName) != -1) {
			name = citys['name'];
			key = citys['areacode'];
			break;
		}
...
function iGetCityKey(cityName) {
	var name = "";
	var key = "";
	for (var i = 0; i < chineseCities.length; i++) {
		var citys = chineseCities[i];
		if (cityName.indexOf(citys['name']) != -1
				|| citys['name'].indexOf(cityName) != -1) {
			name = citys['name'];
			key = citys['pinyin'].toLowerCase();
			break;
		}
	}
	return [ name, key ];
